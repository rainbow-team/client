...
export class BusinessModulesComponent implements OnInit {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: '监管法规信息',
          id: 'law',
          route: '/supersivion/law',
          breadcrumbList: ['监管信息', '监管法规信息']
        },
        {
          name: '安全生产培训信息',
          id: 'producetrain',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          id: 'umine',
          route: '/unit/umine',
          breadcrumbList: ['营运单位及设施', '铀矿冶单位信息']
        },
        {
          name: '核设备单位信息',
          id: 'equipdepart',
      ...
      children: [
        {
          ...
          id: 'fac',
          route: '/permit/fac',
          breadcrumbList: ['核安全许可', '核设施许可信息']
        },
        {
          name: '核安全设备许可信息',
          id: 'equip',
          route: '/permit/equip',
          breadcrumbList: ['核安全许可', '核安全设备许可信息']
        },
        {
          name: '核活动许可信息',
          id: 'activity',
          route: '/permit/activity',
          breadcrumbList: ['核安全许可', '核活动许可信息']
        },
        {
          name: '铀尾矿（渣）库许可信息',
          id: 'umineplace',
      ...
      children: [
        {
          ...
          id: 'fac',
          route: '/check/fac',
          breadcrumbList: ['核安全审评', '核设施审评信息']
        },
        {
          name: '核安全设备审评信息',
          id: 'equip',
          route: '/check/equip',
          breadcrumbList: ['核安全审评', '核安全设备审评信息']
        },
        {
          name: '核活动及其他审评信息',
          id: 'activity',
      ...
      children: [
        {
          ...
          id: 'daily',
          route: '/monitor/daily',
          breadcrumbList: ['核安全监督', '日常监督信息']
        },
        {
          name: '监督检查信息',
          id: 'check',
          route: '/monitor/check',
          breadcrumbList: ['核安全监督', '监督检查信息']
        },
        {
          name: '监督见证信息',
          id: 'witness',
          route: '/monitor/witness',
          breadcrumbList: ['核安全监督', '监督见证信息']
        },
        {
          name: '监督报告信息',
          id: 'report',
          route: '/monitor/report',
          breadcrumbList: ['核安全监督', '监督报告信息']
        }
      ],
      isopen: false
    },
      ...
      children: [
        {
          ...
          id: 'fac',
          route: '/security/fac',
          breadcrumbList: ['安全信息', '核设施安全问题']
        },
        {
          name: '核安全设备安全问题',
          id: 'equip',
          route: '/security/equip',
          breadcrumbList: ['安全信息', '核安全设备安全问题']
        },
        {
          name: '铀尾矿(渣)库安全问题',
          id: 'umineplace',
        ...
        },
        {
          name: '事故事件',
          id: 'accident',
          route: '/security/accident',
          breadcrumbList: ['安全信息', '事故事件']
        }
      ],
      isopen: false
    },
  ...
  ngOnInit() {
    ...
    if (this.isIndex) {
      this.statisticsSercice.getHomeNumer().subscribe(res => {
