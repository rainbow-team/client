...
export class ReportAddComponent implements OnInit {
  ...
  constructor(private msg: NzMessageService, private router: Router,
    ...
    private reportMonitorSercice: ReportMonitorSercice, private orgSercice: OrgSercice) { }
  ...
  ngOnInit() {
    ...
    if (id) {
      this.reportMonitorSercice.getReportMonitorById(id).subscribe((res) => {
        this.data = res.msg;
      });
  ...
  save() {
    ...
    this.reportMonitorSercice.saveOrUpdateReportMonitor(this.data).subscribe((res) => {
      if (res.code == 200) {
        this.msg.create('success', '保存成功');
        this.router.navigate(['/monitor/report']);
      } else {
